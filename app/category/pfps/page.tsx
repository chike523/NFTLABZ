...
export default async function PFPsPage() {
  const slug = 'pfps'
  ...
  const categoryStats = {
    ...
    description: category.description || "Explore PFP NFTs"
  }
  ...
  return (
    <main className="min-h-screen bg-background" suppressHydrationWarning>
      ...
      <CategoryHeader 
        ...
        backgroundImage="/pfp.webp"
        floatingImage="/surreal-pink-doll-falling-artistic.jpg"
      />
      <NFTGrid items={items} />
