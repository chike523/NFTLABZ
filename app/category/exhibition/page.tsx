...
export default async function ExhibitionPage() {
  ...
  const categoryStats = {
    ...
    description: category.description || "Explore Exhibition NFTs"
  }
  ...
  return (
    <main className="min-h-screen bg-background" suppressHydrationWarning>
      ...
      <CategoryHeader 
        ...
        backgroundImage="/gothic-cathedral-architecture-dramatic.jpg"
        floatingImage="/dark-gothic-castle-fantasy.jpg"
      />
      <NFTGrid items={items} />
