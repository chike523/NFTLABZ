...
export default async function PhotographyPage() {
  ...
  const categoryStats = {
    ...
    description: category.description || "Explore Photography NFTs"
  }
  ...
  return (
    <main className="min-h-screen bg-background" suppressHydrationWarning>
      ...
      <CategoryHeader 
        ...
        backgroundImage="/serene-meditation-nature-scene.jpg"
        floatingImage="/mother-child-emotional-portrait.jpg"
      />
      <NFTGrid items={items} />
