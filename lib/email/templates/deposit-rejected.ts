export interface DepositRejectedData {
  username: string
  amount: string
  amountUsd?: string
  reason?: string
...
export function getDepositRejectedTemplate(data: DepositRejectedData) {
  return {
    subject: `❌ Deposit Rejected - ${data.amount} ETH`,
    html: `
<!DOCTYPE html>
<html>
<head>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="600" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); padding: 40px 30px; text-align: center;">
              <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: 700;">Deposit Not Approved</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 0 40px 30px;">
              ...
              <p style="margin: 0 0 20px; color: #333333; font-size: 16px; line-height: 1.6;">
                We're unable to approve your recent deposit request.
              </p>
              ...
              <ul style="margin: 0 0 20px; padding-left: 20px; color: #333333; font-size: 15px; line-height: 1.8;">
                <li>Verify your transaction details are correct</li>
                <li>Ensure you sent from the correct wallet address</li>
              ...
              <div style="text-align: center; margin: 30px 0 20px;">
                ...
                <a href="${data.siteUrl}/dashboard/transactions" style="display: inline-block; background-color: #6b7280; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-weight: 600; font-size: 16px;">
                  View Transactions
                </a>
              </div>
            </td>
...
- Ensure you sent from the correct wallet address
- Contact support if you believe this is an error

Contact Support: ${data.siteUrl}/dashboard/support
View Transactions: ${data.siteUrl}/dashboard/transactions
